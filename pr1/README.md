# pr1 serverless API
The pr1 project, created with [`aws-serverless-java-container`](https://github.com/awslabs/aws-serverless-java-container).
...
...
Mounting webapp.StreamLambdaHandler::handleRequest (java8) at http://127.0.0.1:3000/{proxy+} [OPTIONS GET HEAD POST PUT DELETE PATCH]
...
```
    ...
    "Stacks": [
        {
            ...
            "Description": "AWS Serverless Spring API - webapp::pr1", 
            "Tags": [], 
            "Outputs": [
                {
